...
|---|---|---|---|---|---|---|
| stacked | stacked_bar_composition | ok | ok | ok | ok | 1 |
| pca_small_markers | pca_scatter_from_matrix | ok | ok | ok | ok | 0 |
| pca_large_markers | pca_scatter_from_matrix | ok | ok | ok | ok | 0 |
| manhattan | manhattan_plot | ok | ok | ok | ok | 0 |
| manhattan_custom | manhattan_plot | ok | ok | ok | ok | 0 |
