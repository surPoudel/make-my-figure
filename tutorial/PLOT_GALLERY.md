...
| <img src="screenshots/gallery/boxplot_or_violin_with_points.png" width="160"> | **Box / violin plot with points**<br>`boxplot_or_violin_with_points` | Show full distributions per group as box or violin plots with overlaid points | x, y | [tutorial](plots/boxplot_or_violin_with_points.md) | - |
